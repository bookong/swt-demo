package net.bookong.demo.swt.ibm_os_Jface2.l3;
 ...
 *
 * @author barryf
 * @see https://www.ibm.com/developerworks/cn/opensource/os-jface3
 */
public class Tree31App extends BasicApplication {
    ...
    protected Tree createTree(Composite parent) {
        ...
        TreeColumn idCol = new TreeColumn(tree, SWT.LEFT);
        idCol.setText("Id");
        idCol.setWidth(125);
        TreeColumn nameCol = new TreeColumn(tree, SWT.LEFT);
        nameCol.setText("Name");
        nameCol.setWidth(150);
        TreeColumn ageCol = new TreeColumn(tree, SWT.LEFT);
        ageCol.setText("Age");
        ageCol.setWidth(50);
        TreeColumn addrCol = new TreeColumn(tree, SWT.LEFT);
        addrCol.setText("Address");
        addrCol.setWidth(150);
        TreeColumn phoneCol = new TreeColumn(tree, SWT.LEFT);
        phoneCol.setText("Phone Number");
        phoneCol.setWidth(100);
    ...
    protected static final String[][] nodes = { { "123-45-6789", "John Smith", "50", "123 Any Street", "512-123-4567" },
