package net.bookong.demo.swt.ibm_os_Jface2.l4;
 ...
 *
 * @author barryf
 * @see https://www.ibm.com/developerworks/cn/opensource/os-jface4/
 */
abstract public class BasicApplication extends Composite {
    ...
    protected Image createImage(Device device, String path) {
        ...
        return new Image(device, BasicApplication.class.getResource(path).getPath());
    }
