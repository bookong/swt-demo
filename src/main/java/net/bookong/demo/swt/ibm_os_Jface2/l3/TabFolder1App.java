...
public class TabFolder1App extends BasicApplication {
    ...
    protected static int[]          colorIds   = { SWT.COLOR_WHITE, SWT.COLOR_BLUE, SWT.COLOR_CYAN, SWT.COLOR_GRAY, SWT.COLOR_GREEN, SWT.COLOR_MAGENTA, SWT.COLOR_RED,
                                                   SWT.COLOR_YELLOW, SWT.COLOR_BLACK };

    protected static final String[] popupItems = { "Select All", "Cut", "Copy", "Paste" };
