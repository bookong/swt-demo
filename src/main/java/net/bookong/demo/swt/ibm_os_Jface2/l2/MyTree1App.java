...
import net.bookong.demo.swt.ibm_os_Jface2.l4.BasicApplication;
 ...
 */
public class MyTree1App extends BasicApplication {
     ...
     * Constructor.
     */
    public MyTree1App(Shell shell, int style){
    ...
    protected void setTreeItemContents(TreeItem ti, Node root) {
        ...
        if (children != null && children.size() > 0) {
            for (Iterator i = children.iterator(); i.hasNext();) {
                ...
                tix.setImage(new Image(getDisplay(), MyTree1App.class.getResource("barapp1.gif").getPath()));
    ...
    public static void main(String[] args) {
        run(MyTree1App.class.getName(), "Tree1App Example", SWT.NONE, 400, 300, args);
    }
}
